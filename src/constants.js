...
// atomic swap contract function index
export const ATOMIC_SWAP_CONTRACT_LOCK_FUNCIDX = 0;
export const ATOMIC_SWAP_CONTRACT_SOLVE_PUZZLE_FUNCIDX = 1;
export const ATOMIC_SWAP_CONTRACT_EXPIRE_WITHDRAW_FUNCIDX = 2;
