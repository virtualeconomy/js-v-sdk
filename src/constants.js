...
// swap contract function index
export const SWAP_CONTRACT_SUPERSEDE_FUNCIDX = 0
export const SWAP_CONTRACT_SETSWAP_FUNCIDX = 1
export const SWAP_CONTRACT_ADDLIQUIDITY_FUNCIDX = 2
export const SWAP_CONTRACT_REMOVELIQUIDITY_FUNCIDX = 3
export const SWAP_CONTRACT_SWAPTOKENFOREXACTBASE_FUNCIDX = 4
export const SWAP_CONTRACT_SWAPEXACTTOKENFORBASE_FUNCIDX = 5
export const SWAP_CONTRACT_SWAPTOKENFOREXACTTARGET_FUNCIDX = 6
export const SWAP_CONTRACT_SWAPEXACTTOKENFORTARGET_FUNCIDX = 7
